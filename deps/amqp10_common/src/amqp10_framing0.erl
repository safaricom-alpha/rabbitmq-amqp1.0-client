...
encode(Frame = #'v1_0.header'{}) ->
    amqp10_framing:encode_described('list', 112, Frame);
encode(Frame = #'v1_0.delivery_annotations'{}) ->
    amqp10_framing:encode_described('annotations', 113, Frame);
encode(Frame = #'v1_0.message_annotations'{}) ->
    amqp10_framing:encode_described('annotations', 114, Frame);
encode(Frame = #'v1_0.properties'{}) ->
    amqp10_framing:encode_described('list', 115, Frame);
encode(Frame = #'v1_0.application_properties'{}) ->
    amqp10_framing:encode_described('map', 116, Frame);
encode(Frame = #'v1_0.data'{}) ->
    amqp10_framing:encode_described('binary', 117, Frame);
encode(Frame = #'v1_0.amqp_sequence'{}) ->
    amqp10_framing:encode_described('list', 118, Frame);
encode(Frame = #'v1_0.amqp_value'{}) ->
    amqp10_framing:encode_described('*', 119, Frame);
encode(Frame = #'v1_0.footer'{}) ->
    amqp10_framing:encode_described('annotations', 120, Frame);
encode(Frame = #'v1_0.received'{}) ->
    amqp10_framing:encode_described('list', 35, Frame);
encode(Frame = #'v1_0.accepted'{}) ->
    amqp10_framing:encode_described('list', 36, Frame);
encode(Frame = #'v1_0.rejected'{}) ->
    amqp10_framing:encode_described('list', 37, Frame);
encode(Frame = #'v1_0.released'{}) ->
    amqp10_framing:encode_described('list', 38, Frame);
encode(Frame = #'v1_0.modified'{}) ->
    amqp10_framing:encode_described('list', 39, Frame);
encode(Frame = #'v1_0.source'{}) ->
    amqp10_framing:encode_described('list', 40, Frame);
encode(Frame = #'v1_0.target'{}) ->
    amqp10_framing:encode_described('list', 41, Frame);
encode(Frame = #'v1_0.delete_on_close'{}) ->
    amqp10_framing:encode_described('list', 43, Frame);
encode(Frame = #'v1_0.delete_on_no_links'{}) ->
    amqp10_framing:encode_described('list', 44, Frame);
encode(Frame = #'v1_0.delete_on_no_messages'{}) ->
    amqp10_framing:encode_described('list', 45, Frame);
encode(Frame = #'v1_0.delete_on_no_links_or_messages'{}) ->
    amqp10_framing:encode_described('list', 46, Frame);
encode(Frame = #'v1_0.sasl_mechanisms'{}) ->
    amqp10_framing:encode_described('list', 64, Frame);
encode(Frame = #'v1_0.sasl_init'{}) ->
    amqp10_framing:encode_described('list', 65, Frame);
encode(Frame = #'v1_0.sasl_challenge'{}) ->
    amqp10_framing:encode_described('list', 66, Frame);
encode(Frame = #'v1_0.sasl_response'{}) ->
    amqp10_framing:encode_described('list', 67, Frame);
encode(Frame = #'v1_0.sasl_outcome'{}) ->
    amqp10_framing:encode_described('list', 68, Frame);
encode(Frame = #'v1_0.open'{}) ->
    amqp10_framing:encode_described('list', 16, Frame);
encode(Frame = #'v1_0.begin'{}) ->
    amqp10_framing:encode_described('list', 17, Frame);
encode(Frame = #'v1_0.attach'{}) ->
    amqp10_framing:encode_described('list', 18, Frame);
encode(Frame = #'v1_0.flow'{}) ->
    amqp10_framing:encode_described('list', 19, Frame);
encode(Frame = #'v1_0.transfer'{}) ->
    amqp10_framing:encode_described('list', 20, Frame);
encode(Frame = #'v1_0.disposition'{}) ->
    amqp10_framing:encode_described('list', 21, Frame);
encode(Frame = #'v1_0.detach'{}) ->
    amqp10_framing:encode_described('list', 22, Frame);
encode(Frame = #'v1_0.end'{}) ->
    amqp10_framing:encode_described('list', 23, Frame);
encode(Frame = #'v1_0.close'{}) ->
    amqp10_framing:encode_described('list', 24, Frame);
encode(Frame = #'v1_0.error'{}) ->
    amqp10_framing:encode_described('list', 29, Frame);
encode(Frame = #'v1_0.coordinator'{}) ->
    amqp10_framing:encode_described('list', 48, Frame);
encode(Frame = #'v1_0.declare'{}) ->
    amqp10_framing:encode_described('list', 49, Frame);
encode(Frame = #'v1_0.discharge'{}) ->
    amqp10_framing:encode_described('list', 50, Frame);
encode(Frame = #'v1_0.declared'{}) ->
    amqp10_framing:encode_described('list', 51, Frame);
encode(Frame = #'v1_0.transactional_state'{}) ->
    amqp10_framing:encode_described('list', 52, Frame);
